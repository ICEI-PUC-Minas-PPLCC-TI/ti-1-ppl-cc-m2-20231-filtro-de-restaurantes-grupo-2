...
function idrestaurante() {
    ...
    let item = `
            ...
            <div class="card-body">
           <h5 class="card-title">${dados.restaurantes[input].nome}</h5>
           <p class="card-text">     ${dados.restaurantes[input].descricao}</p>
           <p></p>
           <p>Localização: ${dados.restaurantes[input].localizacao}</p>
           <p>Telefone: ${dados.restaurantes[input].telefone}</p>
           <p>Email: ${dados.restaurantes[input].email}</p>
           <p>Tipo de Culinaria: ${dados.restaurantes[input].tipo_cozinha}</p>
           <p>Faixa de preço: ${dados.restaurantes[input].faixa_preco}</p>
           <p>Delivery: ${dados.restaurantes[input].delivery}</p>
           <p>Horario de funcionamento: ${dados.restaurantes[input].horario_funcionamento}</p>
           <div class="con-like">
<input title="like" type="checkbox" class="like" onclick="favorito(${input})">
<div class="checkmark">
  ...
  <label for="star1" title="text"></label>
           ...
           <a href="#" class="btn btn-primary" onclick="filtro()">Voltar para o filtro</a>
            </div>`
